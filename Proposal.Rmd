...
We do not need any teaching assistants. 
...
- We briefly explain the most popular methods on risk estimation, anonymisation and measurement of data utility. 
- Directly after discussing a method we demonstrate it through code examples on a toy and/or complex data set. 
- Afterwards we step back to discuss the whole workflow when anonymizing a complex data set. 
- In the end of the tutorial there is space for hands-on code in an interactive manner and guided by the course leaders. 
...
- Publication: [Journal of Statistical Software: sdcMicro](https://www.jstatsoft.org/article/view/v067i04)
...
- sdcMicro devolopment on [github](https://github.com/sdcTools/sdcMicro)
- sdcMicro [stable CRAN version](https://cran.r-project.org/web/packages/sdcMicro/index.html)
