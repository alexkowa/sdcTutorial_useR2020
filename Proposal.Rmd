...
The most recent published version of [sdcMicro](https://cran.r-project.org/package=sdcMicro) in a recent R version is the only requirement. We will work with example data of reasonable size, so runtime will be short on a regular laptop computer.
...
- Publication about [sdc app](https://www.mdpi.com/1999-4893/12/9/191/htm) and a [online test version](https://sdctools.shinyapps.io/sdcapp/).
- Book on SDC in [Springer](https://www.springer.com/de/book/9783319502700)

Resources:

- sdcMicro development on [github](https://github.com/sdcTools/sdcMicro)
